<footer class="border-t border-gray-200 bg-white px-4 pt-12 pb-8 text-white">
	<div
	...
	>
		...
		<div class="mt-6 block w-full pl-10 text-sm sm:flex lg:mt-0 lg:w-3/4">
			<ul class="flex w-full list-none flex-col p-0 text-left font-medium text-gray-700">
				<li
					class="mt-5 inline-block px-3 py-2 font-bold tracking-wide text-gray-800 uppercase md:mt-0"
				>
					Product
				</li>
				<li class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">
					Features
				</li>
				<li class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">
					Integrations
				...
				<li class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">FAQ</li>
			</ul>
			<ul class="flex w-full list-none flex-col p-0 text-left font-medium text-gray-700">
				<li
					class="mt-5 inline-block px-3 py-2 font-bold tracking-wide text-gray-800 uppercase md:mt-0"
			...
			<div class="flex w-full flex-col text-gray-700">
				<div class="mt-5 inline-block px-3 py-2 font-bold text-gray-800 uppercase md:mt-0">
					Follow Us
				</div>
				<div class="mt-2 flex justify-start pl-4">
					<a
						class="mr-6 flex items-center text-gray-400 no-underline hover:text-gray-600"
						aria-label="facebook"
						target="_blank"
					...
					<a
						class="flex items-center text-gray-400 no-underline hover:text-gray-600"
						aria-label="github"
						target="_blank"
						rel="noopener noreferrer"
						href="https://devdojo.com"
	...
	<div class="mt-10 border-t border-gray-100 pt-4 text-center text-gray-500">
		© 2020 Landmark. All rights reserved.
	</div>

	<div class="mt-2 border-t border-gray-100 pt-4 text-center text-gray-600">
