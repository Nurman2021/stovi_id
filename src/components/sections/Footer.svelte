...
<footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
        ...
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
            ...
            <div class="flex flex-col w-full text-gray-700">
                ...
                <div class="flex justify-start pl-4 mt-2">
                    <a class="flex items-center mr-6 text-gray-400 no-underline hover:text-gray-600" aria-label="facebook"
                    ...
                    <a class="flex items-center mr-6 text-gray-400 no-underline hover:text-gray-600" aria-label="twitter"
                        target="_blank" rel="noopener noreferrer" href="https://devdojo.com">
                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a class="flex items-center text-gray-400 no-underline hover:text-gray-600" aria-label="github"
                        target="_blank" rel="noopener noreferrer" href="https://devdojo.com">
                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="pt-4 mt-10 text-center text-gray-500 border-t border-gray-100">© 2020 Landmark. All rights
        ...
        <div class="pt-4 mt-2 text-center text-gray-600 border-t border-gray-100">Distributed By <a href="https://themewagon.com/">Themewagon</a></div>
</footer>